...
The Silvia's engine is a modified G-type engine used in the Fairlady and Cedric 1500. The bore has been enlarged by 7.2mm and stroke has been shortened by 7.2mm to make it an ultra-short stroke engine with an 0.76 ratio. Some have reported that the 1500cc capacity has been increased only by enlarging the bore, but this is a mistake. As a result, the capacity has increased by 100cc. It seems that the aim is not to increase the piston speed even when the engine rotation speed is increased, and at the same time not to lose torque even at low rotations.
