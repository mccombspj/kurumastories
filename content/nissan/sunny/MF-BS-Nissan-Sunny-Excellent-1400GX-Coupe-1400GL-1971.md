...
title = "Nissan Sunny Excellent 1400GX and Coupe 1400GL (1971)"
weight = 25


date = "2026-03-15T04:50:49-07:00"
...
![Nissan Sunny Excellent 1400GX](/images/MF-BS-Nissan-Sunny-Excellent-1400GX-Coupe-1400GL-1971.jpg)
...
<b><u>The Tough-Running Hybrid</b></u>
...
Then, in January 1970, the model underwent a full redesign under the advertising slogan, “Now the car next door looks small.” Displacement was increased to 1200cc, marking a substantial step forward.
...
Moreover, much of the front suspension and the drivetrain components have been carried over directly, or with slight modifications, from the Bluebird and Skyline.
...
Steering effort has become noticeably heavier, and the overly light feel that characterized previous Sunnys has been thoroughly improved. At high speeds, in particular, it now inspires a good deal of confidence.

There were also favorable remarks regarding the engine’s response and ease of use, with some noting that it ranks among the better examples in the 1400cc class.

On the other hand, a few observations were made concerning high-speed driving. While cruising between roughly 90-120km/h, a droning whine was heard from the drivetrain--possibly from the propeller shaft or the differential, though its exact source was unclear. Another point raised was a booming resonance that becomes particularly noticeable at around 80km/h, but diminishes again at higher speeds.

For the details of these various impressions, we invite readers to turn to the reports from each of our specialists on the following pages.
...
The disc brakes, assisted by a master cylinder, are smooth and strong, requiring only light pedal pressure. Yet they are not overly sensitive, and control is precise and intuitive. At high speed, braking performance is superb, but as speed decreases, the brakes feel somewhat less effective, so the driver must remain mindful of this characteristic.

As always, I approached this test with a critical eye and a somewhat exacting attitude. Regarding handling and stability, I must admit that there was nothing that particularly thrilled me. At the same time, there was nothing I could point to as a real fault, either.

Overall, the Sunny Excellent 1400 leaves the impression of a practical passenger car imbued with a degree of sporty character. Its seemingly ordinary demeanor conceals a surprising amount of talent and capability.

<i>“The steering is responsive, pleasantly firm, and should suit young drivers perfectly.” —Mochizuki</i>

<b><u>Ride Performance: A Question of Sensibility</b></u> <i>(Shigeki Asaoka)</i>

In an era when the “wide selection” approach--catering to users' desire to flaunt their status--is growing ever stronger, here we have yet another car with an in-between-sized engine. Engines now range between 1000cc and 2000cc in increments of 100cc. One can’t help but wonder: is there really a need for so many different engine sizes?
...
<i>“With so many colors on the body, seats, and side trim, matching one’s wardrobe to the car seems challenging.” —Ikuuchi</i>
...
The sedan GX we tested is priced at 647,000 yen at Tokyo dealerships (the coupe GL is 625,000 yen), making it 42,000 yen more than the 1200GX sedan.
...
Comparing their prices, the Sunny 1400GX (4-speed sedan) lists for 647,000 yen; the new Corolla 1400SL (sedan, 5-speed) lists for 654,000 yen, while the 4-speed version is 639,000 yen. Which is the better value depends entirely on personal preference.

Standardizing the 1400 series on regular fuel came at a good time, coinciding with the recent rise in oil prices.
...
This Sunny 1400, reportedly a hybrid of Sunny and Bluebird design, shows that the underlying approach to car-making has not changed. For domestic manufacturers, "playing it safe" seems to remain the basic policy.
...
![Nissan Sunny Excellent 1400GX Bubble Index](/images/MF-BS-Nissan-Sunny-Excellent-1400GX-Coupe-1400GL-1971a.jpg)

The goal of this comprehensive test drive series is to evaluate a car’s overall performance across six key pillars: running performance, handling and stability, ride quality, safety, economy, and product appeal. Our method of assessment is the “Bubble Session”—a system-engineering approach in which six specialists from different fields gather around a hexagonal table (bubble = beehive) to share and exchange opinions.

Each circle in the evaluation diagram shows the specialist’s rating in black, and the more evenly sized the black segments, the more balanced the car is across all six categories. If the black areas vary significantly, the vehicle can be considered to have a more distinctive, individual character.
