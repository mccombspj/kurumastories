...
title = "Nissan Skyline 2000GT (1970)"
weight = 70

date = "2025-12-17T04:50:49-07:00"
...
<b><u>A Gentlemanly GT With Underlying Strength</b></u>
...
Taking a look at overtaking acceleration, it takes 173m and 6.8 seconds to overtake a car traveling at 60km/h, with a final speed of 92km/h. And if you try to overtake a car going 80km/h? The distance doubles to 348m, but the time is still a short 10.3 seconds, and the final speed is 122km/h.

Oguchi said, “We call it gentlemanly, but I can really sense its underlying strength… it’s a powerful car.”

We continued the in-gear performance tests. When accelerating to merge on an on-ramp, an important factor on expressways, it took 251m and 12.9 seconds to go from 40km/h to 100km/h. With the Tomei Expressway’s acceleration lanes being 250m long, there is no need to worry about entering the flow of main lane traffic.
...
In terms of comfort, we found some issues with the seat. “The bottom cushion pinches too tightly at the sides, and you feel like you sink into the middle. But the balance between the cushion and the backrest is off, so your back isn’t supported at the sides when cornering,” said Sano and Sanbon.
...
The interior is finished entirely in black. From the seats to the headliner, everything is black, except for the woodgrain on the dash panel (which feels cheap, being nothing more than a printed pattern on a metal plate). This is probably a matter of personal taste, but we found the black interior quite soothing. 

That said, the steering wheel spokes are not anti-glare treated, and bright trim is used on the interior frames for the front and rear triangular windows. Why they would do this, especially when the exterior surfaces are finished with an anti-glare coating, is hard to understand. It may seem like a small thing, but shiny chrome trim is also scattered around the instrument panel. Despite the increased power and performance, there have been no improvements in this area; it is unchanged from before. 
...
The price is also low for a six-cylinder, 2000cc class GT car. It fully conveys the feel of a high-grade sports sedan. While there are some issues in areas such as the interior, it would not be an exaggeration to describe it as a uniquely accomplished product for a domestically produced car in this class.

When we posed the question, “Who would buy this car, and for what purpose?”, the answers that emerged were: “A capable gentleman who likes sporty cars.” “An active young enthusiast with ambition, good sense, and skill.” Even, “A woman, if she's not interested in showing off, but has real driving ability.” 
