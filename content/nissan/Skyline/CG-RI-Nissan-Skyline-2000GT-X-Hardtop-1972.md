...
Having missed out on testing the 2000GT-X Hardtop at the time of its release, we immediately requested Nissan to send us a sedan GT-X to test the combination of the SU twin-carb engine and the 5-speed gearbox in this newest model. However, Nissan's PR department advised that only a hardtop 2000GT-X was available, and so we headed to Hakone in the hardtop, knowing that we would be reporting on it a little late. The test car, which had been driven about 13,000km, was a premium gasoline version, and fortunately had the optional 5-speed gearbox. The tires were the optional 165SR-14 Bridgestone Radial 11s.
