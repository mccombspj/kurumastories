...
The C/G testers' first impression was that that this engine is powerful, even at high speeds, and that the drivetrain is extremely quiet and smooth. This impression had not changed by the end of the test. The SOHC engine has extremely high intake and exhaust efficiency, and in first and second gears, it can rev freely up to over 7000rpm. Valve gear bounce does not occur even at this speed. In actual driving, there are few opportunities and no point in using such engine speeds, but if you push it up to 6500rpm, it will reach 46km/h in first gear, 70km/h in second gear, and 120km/h in third gear.
